      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="group flex flex-col justify-center items-center space-y-1 w-10 h-10 focus:outline-none cursor-pointer"
          >
            <span
              className={clsx(
                'w-10 h-[6px] rounded transition-all duration-300 transform group-hover:-translate-x-1',
                'bg-black'
              )}
            ></span>
            <span
