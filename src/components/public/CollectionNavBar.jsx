...
export default function CollectionNavBar() {
  ...
  return (
    <>
      <header
        className={clsx(
          'fixed top-0 left-0 w-full z-50 px-6 py-3 flex items-center justify-between transition-colors duration-300',
          'bg-white/70 dark:bg-background/65 backdrop-blur-lg border-b border-slate-200 dark:border-white/10 text-slate-800 dark:text-white shadow-sm dark:shadow-lg'
        )}
      >
              ...
              <div className="relative">
                ...
                >
                  <Avatar className="w-8 h-8 border border-slate-200 dark:border-white/20">
                    ...
                    <AvatarFallback className="bg-slate-200 dark:bg-slate-800 text-slate-850 dark:text-white text-xs font-semibold">
                      {initials}
                    </AvatarFallback>
                  </Avatar>
