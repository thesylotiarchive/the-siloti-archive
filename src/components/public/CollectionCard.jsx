  ...
  return (
    <div className={`relative overflow-visible ${className}`}>
      <Link
        ...
        className="block border border-white/10 rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-[0_12px_24px_rgba(16,185,129,0.15)] hover:border-emerald-500/50 hover:-translate-y-1.5 group bg-slate-900/60 backdrop-blur-md cursor-pointer"
      >
        <div className="relative w-full aspect-[4/3] p-6 flex flex-col items-center justify-center">
          ...
          <div className="relative flex flex-col items-center text-center w-full">
            ...
            <div className="h-[3.6rem] flex flex-col items-center justify-center px-2">
              <h3 className="text-sm font-bold text-white/95 group-hover:text-emerald-400 leading-tight text-center line-clamp-2 transition-colors duration-300 tracking-wide font-sans">
                {collection.name}
              </h3>
              {collection.contributor && (
                <span className="text-[10px] text-white/50 font-semibold uppercase tracking-wider truncate mt-1 max-w-[150px]">
        ...
        {/* Footer info wrapper */}
        <div className="flex items-center gap-2.5 text-xs text-emerald-400 px-4 py-3 bg-slate-950/80 backdrop-blur-md border-t border-white/5">
