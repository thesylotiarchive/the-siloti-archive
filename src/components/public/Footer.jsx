...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-100/50 dark:bg-background text-slate-800 dark:text-white relative overflow-hidden border-t border-slate-200 dark:border-white/10 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2 space-y-6">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <div className="relative p-1 bg-slate-200/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl transition-all duration-300 group-hover:border-emerald-400/50 shadow-lg">
                <Image
                  src="/logo.png"
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-xl font-extrabold tracking-wider text-slate-900 dark:text-white group-hover:text-emerald-400 transition-colors duration-300">
                  Sylheti Archive
                </span>
                <span className="text-[10px] text-slate-500 dark:text-white/55 font-light">An Initiative of</span>
            ...
            <p className="text-sm text-slate-650 dark:text-white/60 leading-relaxed max-w-md font-light">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full flex items-center justify-center bg-slate-200/50 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-650 dark:text-white/70 hover:text-slate-900 dark:hover:text-white hover:bg-emerald-400/15 hover:border-emerald-400 transition-all duration-300 group"
                >
                  <Image 
                    src={soc.logo} 
                    alt={soc.label} 
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={i}>
                  <Link 
                    href={link.href}
                    className="group inline-flex items-center gap-1 text-sm text-slate-600 dark:text-white/60 hover:text-slate-900 dark:hover:text-white transition-colors duration-200"
                  >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3.5 text-sm text-slate-650 dark:text-white/70 font-light">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:silotiarchivercc@gmail.com" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                  silotiarchivercc@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-emerald-400 shrink-0" />
                <a href="tel:+919957116126" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                  +91 9957116126
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Globe className="w-4 h-4 text-amber-300 shrink-0" />
                <a href="https://sylhetiarchivercc.org/" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 dark:hover:text-white transition-colors">
        ...
        {/* Bottom Line */}
        <div className="pt-8 mt-8 border-t border-slate-200 dark:border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-white/40">
