...
import { Trash2, Pencil, Plus, Shield, User as UserIcon } from "lucide-react";
...
function RoleBadge({ role }) {
  const color = role === "SUPERADMIN" ? "bg-red-100 text-red-700" :
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {filtered
          .filter(u => u.id !== me?.id) // avoid duplicating current admin in the list
          .map((u) => (
