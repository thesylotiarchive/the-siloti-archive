    ...
    return (
      <section className="relative z-10 w-full min-h-[calc(100vh-220px)] flex items-center justify-center py-12 px-4">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm text-white/50">Loading profile data...</span>
        </div>
      </section>
    );
  }
    ...
    <section className="relative z-10 w-full min-h-[calc(100vh-220px)] py-12 px-4 sm:px-6 lg:px-8 selection:bg-emerald-400 selection:text-slate-950">
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <button
            onClick={() => router.push("/")}
            className="flex items-center gap-2 text-xs uppercase tracking-wider text-white/40 hover:text-white transition-colors duration-200"
          >
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/5 border border-white/10 rounded-full">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-300">My Account Settings</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 backdrop-blur-md shadow-2xl flex flex-col items-center text-center space-y-6 h-fit">
            ...
            <div>
              <h3 className="text-xl font-light text-white leading-tight">
                {user?.name || <span className="italic text-white/30">No Name Set</span>}
              </h3>
            ...
            <div className="w-full space-y-3 pt-4 border-t border-white/5">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="px-2.5 py-0.5 bg-emerald-500/10 border border-emerald-500/25 text-emerald-400 font-bold uppercase tracking-widest rounded-full text-[9px]">
                  {user?.role}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-white/40 flex items-center gap-1">
                  <Calendar className="w-3.5 h-3.5 text-white/30" /> Joined
                </span>
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-white/70 font-medium truncate max-w-[150px]" title={user?.email}>
                  {user?.email}
                </span>
              </div>
            </div>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-8 backdrop-blur-md shadow-2xl space-y-6">
              ...
              <form onSubmit={handleDetailsSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white placeholder-white/30 focus:outline-none focus:border-emerald-400 transition-colors"
                    />
                  </div>
                ...
                {/* Username (Disabled) */}
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase tracking-wider text-white/30 block font-semibold pl-1">
                ...
                <div className="space-y-3.5 border border-white/5 bg-white/[0.01] rounded-2xl p-4">
                  <label className="text-[10px] uppercase tracking-wider text-white/40 block font-semibold pl-1">
                  ...
                  {avatarTab === "svg" ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-3 bg-white/5 border border-dashed border-white/10 rounded-xl min-h-[80px]">
                      {isUploading ? (
                        <div className="flex flex-col items-center gap-1.5">
                          <div className="w-4 h-4 border-2 border-emerald-400/30 border-t-emerald-400 rounded-full animate-spin"></div>
                          <span className="text-[10px] text-white/50">Uploading image...</span>
                        </div>
                      ) : (
                        <UploadButton
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      placeholder="••••••••"
                      className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-4 pr-12 text-sm text-white placeholder-white/35 focus:outline-none focus:border-emerald-400 transition-colors"
                    />
                    <button
                      type="button"
